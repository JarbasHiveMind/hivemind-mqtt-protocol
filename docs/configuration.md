...
| `tls_insecure` | `false` | Disable certificate verification. Use this only in a controlled test environment. |
...
| `health_file` | none | File created only while the broker connection is established; suitable for container readiness probes. |
