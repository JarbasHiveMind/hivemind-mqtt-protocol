...
- fix: give each listener replica its own MQTT client id [\#19](https://github.com/JarbasHiveMind/hivemind-mqtt-protocol/pull/19) ([JarbasAl](https://github.com/JarbasAl))

## [0.2.4a1](https://github.com/JarbasHiveMind/hivemind-mqtt-protocol/tree/0.2.4a1) (2026-09-10)

[Full Changelog](https://github.com/JarbasHiveMind/hivemind-mqtt-protocol/compare/0.2.3a1...0.2.4a1)

**Merged pull requests:**

- fix: build the client connection without the retired crypto\_key field [\#20](https://github.com/JarbasHiveMind/hivemind-mqtt-protocol/pull/20) ([JarbasAl](https://github.com/JarbasAl))

## [0.2.3a1](https://github.com/JarbasHiveMind/hivemind-mqtt-protocol/tree/0.2.3a1) (2026-09-01)

[Full Changelog](https://github.com/JarbasHiveMind/hivemind-mqtt-protocol/compare/0.2.2a6...0.2.3a1)

**Merged pull requests:**

- fix: accept an optional close code in the disconnect callback \(widened HiveMind contract\) [\#18](https://github.com/JarbasHiveMind/hivemind-mqtt-protocol/pull/18) ([JarbasAl](https://github.com/JarbasAl))

## [0.2.2a6](https://github.com/JarbasHiveMind/hivemind-mqtt-protocol/tree/0.2.2a6) (2026-08-15)

[Full Changelog](https://github.com/JarbasHiveMind/hivemind-mqtt-protocol/compare/0.2.2a5...0.2.2a6)

**Merged pull requests:**

- docs: add AGENTS.md with per-repo agent conventions [\#17](https://github.com/JarbasHiveMind/hivemind-mqtt-protocol/pull/17) ([JarbasAl](https://github.com/JarbasAl))
